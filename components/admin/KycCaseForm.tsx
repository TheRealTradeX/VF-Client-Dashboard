...
export function KycCaseForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-zinc-950 border border-zinc-900 rounded-xl p-5 space-y-4">
      <div>
        <h2 className="text-white text-lg mb-1">KYC Intake</h2>
        <p className="text-sm text-zinc-500">Create or update a KYC case for a user.</p>
      </div>
